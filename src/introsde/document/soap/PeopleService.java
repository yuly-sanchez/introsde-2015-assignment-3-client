 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://soap.document.introsde/", wsdlLocation = "https://agile-shelf-1769.herokuapp.com/soap/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://soap.document.introsde/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://agile-shelf-1769.herokuapp.com/soap/people?wsdl");
    ...
    public People getPeopleImplPort() {
        return super.getPort(new QName("http://soap.document.introsde/", "PeopleImplPort"), People.class);
    }
    ...
    public People getPeopleImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.document.introsde/", "PeopleImplPort"), People.class, features);
    }
